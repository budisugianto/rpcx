...
import (
	...
	"github.com/budisugianto/rpcx/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/budisugianto/rpcx/server"`)
	fmt.Fprintln(w, `  "github.com/budisugianto/rpcx/serverplugin"`)
